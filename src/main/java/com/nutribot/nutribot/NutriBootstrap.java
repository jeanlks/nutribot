...
public class NutriBootstrap {
    ...
    public List<Question> getQuestions(){
        ...
        questions.add(new Question(22, new String[]{"Quantas calorias tem a dieta?", "Quantas kcal tem a dieta?"}
                , new String[]{"A dieta possui 1931kcal. "}));
        ...
        questions.add(new Question(28, new String[]{"O que devo comprar para dieta artesanal?","Lista de compras"}
                , new String[]{"Vou lhe enviar a lista de compras, só um momento."}, new String[]{"listacompras.png"}));
        ...
        questions.add(new Question(29, new String[]{"Quais as interações entre remédios e nutrientes ?", "Quais as interações entre fármacos e nutrientes?"}
                ...
                "3. Levotiroxina: pode interagir com farinha de soja, cereais de semente de algodão, nozes e dieta à base de fibras, podendo diminuir a absorção do fármaco. "}));


        questions.add(new Question(30, new String[]{"Qual a quantidade que devo usar de cada ingrediente para dieta artesanal ? "}
                , new String[]{"As quantidades de cada ingrediente serão iguais as da imagem a seguir:"}, new String[]{"qnt.png"}));
